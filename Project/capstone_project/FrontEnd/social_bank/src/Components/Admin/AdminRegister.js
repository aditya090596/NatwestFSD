            ...
            <Grid >
                <Paper elevation={24} style={paperStyle}>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <TextField fullWidth label='Employee ID' placeholder="Enter your Employee ID" style={margin} id="empID" name="empID" value={formik.values.empID} onBlur={formik.handleBlur} onChange={formik.handleChange} error={formik.errors.empID && formik.touched.empID ? true : false} helperText={formik.errors.empID && formik.touched.empID ? formik.errors.empID : null} />
                        ...
                        <TextField fullWidth label='Role' placeholder="Enter your role" style={margin} id="role" name="role" value={formik.values.role} onBlur={formik.handleBlur} onChange={formik.handleChange} error={formik.errors.role && formik.touched.role ? true : false} helperText={formik.errors.role && formik.touched.role ? formik.errors.role : null} />
