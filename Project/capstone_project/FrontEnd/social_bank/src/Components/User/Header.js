                            ...
                            {(localStorage.getItem('token') != null) ?
                                <>
                                    ...
                                    >
                                        ...
                                        <Tab label="Your Dashboard" onClick={() => { navigate("/user/dashboard") }} />
                                        <Tab label="Contact Us" onClick={() => { navigate("/user/contactus") }} />
                                        <Tab label="FAQs" />
                                    </Tabs>
                                    <Box sx={{ marginLeft: "auto" }}>
                                        ...
                                        >
                                            <List onClick={handleCloseUserMenu}>
                                                ...
                                                <ListItemButton onClick={() => { navigate("/user/changepassword") }}>
                                                    <ListItemIcon>
