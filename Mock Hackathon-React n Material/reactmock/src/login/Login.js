                                ...
                                <div className="row">
                                    <div className="fw-normal my-4 pb-3">
                                        ...
                                        <form onSubmit={formik.handleSubmit} className="mb-5">
                                            <div className="mt-5 ">
                                                <input id="email" label='email' size="lg" wrapperclass='mb-4' name="email" type="text" value={formik.values.email} onBlur={formik.handleBlur} onChange={formik.handleChange} className="form-control form-control-Lg text-center" placeholder="email" />
