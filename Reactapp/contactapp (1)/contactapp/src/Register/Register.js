...
export default function Register() {
    //Here decalring the values where all details will get stored and will display on webpage. If we make any changes there ,it will automatically get replaced here 
    const formik = useFormik({
        ...
        onSubmit: values => {
            fetch('http://localhost:9000/auth/register', {
                ...
                body: JSON.stringify(values) // stringy the values which was in json
            })
                .then(res => res.json())
