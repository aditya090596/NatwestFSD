    ...
    return (
        ...
        <div className="container mt-3">
            ...
            <div className="row">
                ...
                {
                    news.map(item => <DisplayCard deleteHandler={Deletenews} key={item.id} img={item.urlToImage} link={item.url} desc={item.description} author={item.author} title={item.title} />)
                }
