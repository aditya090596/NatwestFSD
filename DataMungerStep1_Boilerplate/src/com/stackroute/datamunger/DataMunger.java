...
//		    String str=words.toString();
	...
	public String getFileName(String queryString) {
		...
		int indexofipl=queryString.indexOf("ipl");
//        System.out.println(s1);
        int indexofcsv=queryString.indexOf("csv");
//        System.out.println(s2);
        String queryString1=queryString.substring(indexofipl, (indexofcsv+3));
 ...
 return queryString1;
	...
	public String getBaseQuery(String queryString) {
		...
		String queryString1=queryString.substring(indexofselect,indexofcsv);
		return queryString1;
	}
...
//		String []newwords=words.split(",");
	...
	public String getConditionsPartQuery(String queryString) {
		...
		if(indexofwhere-6 == -1) {
		return null;}
		else { String str=queryString.substring(indexofwhere).toLowerCase().split("group by | order by")[0].trim();
//		System.out.println(str);
	...
	public String[] getConditions(String queryString) {
        ...
        String [] str = queryString.substring(indexofwhere).toLowerCase().split("group by | order by")[0].trim().split(" and | or ");
...
//		System.out.println(words);
	...
	public String[] getGroupByFields(String queryString) {
		...
		if(indexofgroupby-9==-1) {
			return null;
		}
		else {
		String str=queryString.substring(indexofgroupby);
